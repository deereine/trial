...
def savings(gross_pay, tax_rate, expenses):
    ...
    def savings(gross_pay,tax_rate,expenses):
    money = gross_pay - (gross_pay*tax_rate)
    money_left = int(money - expenses)
    return(money_left)
...
def material_waste(total_material, material_units, num_jobs, job_consumption):
    ...
    material_left = total_material - total_material_consumed
    total_material_left = str(material_left) + material_units
    return(total_material_left)
...
def body_mass_index(weight, height):
    ...
    height_m = (height[0]*0.305) + (height[1]*0.0254)
